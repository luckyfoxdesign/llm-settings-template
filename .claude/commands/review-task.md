...
Full policy and rationale: `docs/product/architecture/verification-contract.md` → Review policy.
...
After the pass: `medium` findings go to `docs/backlog/todo/`, `speculative` to `docs/ideas/`, cosmetic remarks are dropped.
